...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let layerControl = L.control.layers({
        ...
        "Fahrradgeschäfte/-reparatur": themaLayer.bikeshop.addTo(map3),
        "Cafés/Restaurants": themaLayer.coffee.addTo(map3),
    }).addTo(map3);
...
`)
    ...
    const COFFEE = [
        ...
        {
            title: "Alpengasthof Adelshof",
            link: "https://www.adelshof.at/",
            ort: "Birgitz",
            lat: 47.217316987123326,
            lng: 11.287073669342531,
        },
